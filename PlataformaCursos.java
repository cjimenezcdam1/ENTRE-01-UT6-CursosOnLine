...
public class PlataformaCursos
{
    ...
    private Curso obtenerCurso(String lineaCurso) {
        ...
        String nombre = datosCurso[0];
        String textoFecha = datosCurso[1].trim();
        String[] datosFecha = textoFecha.split("/");
        LocalDate fecha = LocalDate.of(Integer.valueOf(datosFecha[2]), 
                            Integer.valueOf(datosFecha[1]),  Integer.valueOf(datosFecha[0]));
        Nivel nivel = Nivel.valueOf(datosCurso[2].toUpperCase().trim());
